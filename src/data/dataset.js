export default [
  {
    ...
    shortDescription:
      "En una búsqueda de la verdad tras un accidente de avión y revela conspiraciones.",
    description:
    ...
    imageUrl:
      "https://i.pinimg.com/564x/93/7a/18/937a18ad0fea62a391c1f694e0024104.jpg",
    facts: {
      totalGender: "Romance",
      totalCast: "Hyun Bin, Son Ye-jin, Seo Ji-hye, Kim Jung-hyun",
      totalSubtitle: "Español",
      totalEpisodes: 16,
    },
  },
  {
    ...
    name: "Itaewon Class",
    shortDescription:
      "Venganza, lucha por la justicia y sueños en el mundo empresarial.",
    description:
      "Itaewon Class es un kdrama que sigue la vida de Park Sae- ro - yi, quien, después de enfrentarse a injusticias, se propone alcanzar el éxito en el competitivo mundo empresarial de Itaewon.Después de abrir su propio bar, Sae - ro - yi se embarca en una búsqueda de redención y venganza.La serie aborda temas de perseverancia, amistad y justicia, mientras los personajes enfrentan desafíos personales y profesionales.Con una trama envolvente, destacadas actuaciones, y una narrativa socialmente relevante, Itaewon Class ha ganado popularidad por su enfoque fresco y mensajes inspiradores",
    imageUrl:
      "https://i.pinimg.com/564x/d5/37/dc/d537dc35d9367dc4239976f605559f8e.jpg",
    facts: {
      totalGender: "Drama",
      totalCast: "Park Seo-joon, Kim Da-mi, Yoo Jae-myung",
      totalSubtitle: "Inglés",
      totalEpisodes: 16,
    },
  },
  {
  ...
  },
  {
    ...
    shortDescription:
      "Una mujer fuerte, un CEO y un misterioso secuestrador. Comedia y romance.",
    description:
      "Strong Woman Do Bong Soon, es un encantador drama surcoreano que sigue la vida de Bong Soon, una joven con una fuerza sobrenatural. Contratada como guardaespaldas del CEO Ahn Min-hyuk, su relación evoluciona de manera inesperada. Mientras Bong Soon navega entre sus habilidades extraordinarias y las complejidades del amor, la trama también aborda la persecución de un criminal en serie. Con toques de comedia romántica, acción y misterio, la serie destaca la fortaleza física y emocional de la protagonista interpretada por Park Bo-young, ofreciendo una experiencia divertida y conmovedora para los espectadores.",
    imageUrl:
      "https://i.pinimg.com/564x/34/d7/4d/34d74d0f72997a88c3205189bc6dc722.jpg",
    facts: {
      totalGender: "Comedia",
      totalCast: "Park Bo-young, Park Hyung-sik, Ji Soo",
      totalSubtitle: "Inglés",
      totalEpisodes: 16,
    },
  },
  ...
  },
  {
    ...
    name: "Hotel Del Luna",
    shortDescription:
      "Un hotel para fantasmas y una historia de amor eterna. Fantasía y romance.",
    description:
      "Hotel Del Luna, es un cautivador kdrama que se desarrolla en un hotel místico para almas errantes. Jang Man-wol, la gerente del hotel, está condenada a manejar el establecimiento debido a su pasado. Cuando el gerente asistente Gu Chan-sung llega, su vida se entrelaza con el destino de las almas en transición. La serie explora temas de redención, amor y perdón, todo mientras revela secretos oscuros. La actuación magistral de IU y Yeo Jin-goo, junto con la estética visual única, hace de Hotel Del Luna una experiencia emocionante y conmovedora que ha resonado internacionalmente.",
    imageUrl:
      "https://i.pinimg.com/564x/8a/9a/e7/8a9ae7a390357e298ba391d7e7f29305.jpg",
    facts: {
      totalGender: "Fantasía",
      totalCast: "IU, Yeo Jin-goo, Lee Do-hyun",
      totalSubtitle: "Español",
      totalEpisodes: 16,
    },
  },
  {
    ...
    name: "Reply 1988",
    shortDescription:
      "Amistad y romance en la década de 1980. Comedia y drama.",
    description:
      "Reply 1988, es un nostálgico kdrama que se centra en la vida cotidiana de familias y amigos en Seúl durante el año 1988. La serie se enfoca en cinco amigos cercanos y sus familias mientras experimentan el crecimiento, el amor y los desafíos. A través de la comedia, la amistad y la emoción, Reply 1988 captura la esencia de la juventud y la conexión familiar. Con una narrativa encantadora y personajes entrañables, el drama destaca la importancia de la comunidad y las relaciones personales en una época específica de la historia surcoreana.",
    imageUrl:
      "https://i.pinimg.com/564x/12/03/85/1203853332caeafd81a6310cac7846e4.jpg",
    facts: {
      totalGender: "Comedia",
      totalCast: "Hyeri, Park Bo-gum, Go Kyung-pyo, Ryu Jun-yeol",
      totalSubtitle: "Inglés",
      totalEpisodes: 20,
    },
  },
  ...
  },
  {
    ...
    shortDescription:
      "Salud mental, cuentos de hadas y amor no convencional. Drama y romance.",
    description:
    ...
    imageUrl:
      "https://i.pinimg.com/564x/9d/c0/b2/9dc0b2a7f40c2c84c970e485c0ebf70e.jpg",
    facts: {
      totalGender: "Drama",
      totalCast: "Kim Soo-hyun, Seo Ye-ji, Oh Jung-se",
      totalSubtitle: "Coreano",
      totalEpisodes: 16,
    },
  },
  {
    ...
    name: "Vagabond",
    shortDescription:
      "Intriga, conspiraciones y acción. Un doble juego mortal.",
    description:
      "Vagabond es un emocionante drama surcoreano que combina acción, intriga y drama. La trama sigue a Cha Dal-gun, interpretado por Lee Seung-gi, un doble de acrobacias cuya vida se ve trastornada cuando su sobrina muere en un misterioso accidente aéreo. En su búsqueda de respuestas, se une a Go Hae-ri, interpretada por Bae Suzy, una agente encubierta de inteligencia. Juntos, desentrañan una compleja red de conspiraciones y corrupción que involucra a grandes corporaciones y el gobierno. Con giros inesperados, intensas escenas de acción y sólidas actuaciones, Vagabond mantiene a los espectadores al borde de sus asientos.",
    imageUrl:
      "https://i.pinimg.com/564x/28/05/47/280547e94a519e711a4d110613ff7878.jpg",
    facts: {
      totalGender: "Acción",
      totalCast: "Lee Seung-gi, Bae Suzy, Shin Sung-rok",
      totalSubtitle: "Español",
      totalEpisodes: 16,
    },
  },
  ...
  },
  {
    ...
    name: "The Heirs",
    shortDescription:
      "Amor en el mundo de la alta sociedad y la herencia. Romance y drama.",
    description:
    ...
    imageUrl:
      "https://i.pinimg.com/564x/26/da/29/26da29abd4a4300235b185f1f299749f.jpg",
    facts: {
      totalGender: "Drama",
      totalCast: "Lee Min-ho, Park Shin-hye, Kim Woo-bin",
      totalSubtitle: "Español",
      totalEpisodes: 20,
    },
  },
  ...
  },
  {
    ...
    description:
      "Un emocionante drama que se desarrolla en el vibrante Seúl de 1994. La trama sigue a un grupo de amigos universitarios que comparten una casa, explorando sus relaciones y experiencias de vida durante esa década. Con un enfoque nostálgico y humorístico, la serie destaca las diferencias culturales entre regiones de Corea y aborda temas como la amistad, el amor y las decisiones de vida. A través de flash-forwards, mantiene a la audiencia adivinando la identidad del esposo de la protagonista, creando intriga y emoción en cada episodio. Reply 1994 ofrece una conmovedora mirada a la juventud y la evolución personal.",
    imageUrl:
      "https://i.pinimg.com/564x/16/7c/40/167c401bf3ae77109cdaae44a6893b41.jpg",
    facts: {
      totalGender: "Comedia",
      totalCast: "Go Ara, Jung Woo, Yoo Yeon-seok",
      totalSubtitle: "Inglés",
      totalEpisodes: 21,
    },
  },
